...
import com.chrrissoft.inglishwords.domian.gameplay.keyboard.Keyboard.KeyboardLevel4
...
class KeyboardLevel4Impl(
    private val editor: Editor,
) : KeyboardLevel4 {

    private var word = ""

    private val _state = MutableStateFlow(KeyboardState(buildStructure(English, "")))
